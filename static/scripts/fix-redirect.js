...
const redirects = [
    ...
    [ fromIncludes(`/docs/cloud-edge/`), `/network-edge/` ],
    [ fromIncludes(`/docs/cloud-edge/app-users/`), `/network-edge/app-users/` ],
    [ fromIncludes(`/docs/cloud-edge/edges/`), `/network-edge/edges/` ],
    [ fromIncludes(`/docs/cloud-edge/edges/https/`), `/http/` ],
    [ fromIncludes(`/docs/cloud-edge/edges/tcp/`), `/tcp/` ],
    [ fromIncludes(`/docs/cloud-edge/edges/tls/`), `/tls/` ],
    [ fromIncludes(`/docs/cloud-edge/endpoints/`), `/http/` ],
    [ fromIncludes(`/docs/cloud-edge/ip-policies/`), `/http/#ip-restrictions` ],
    [ fromIncludes(`/docs/cloud-edge/modules/`), `/http/#modules` ],
    [ fromIncludes(`/docs/cloud-edge/modules/circuit-breaker/`), `/http/circuit-breaker/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/compression/`), `/http/compression/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/ip-restrictions/`), `/http/ip-restrictions/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/mutual-tls/`), `/http/mutual-tls/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/oauth/`), `/http/oauth/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/openid-connect/`), `/http/openid-connect/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/request-headers/`), `/http/request-headers/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/response-headers/`), `/http/response-headers/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/saml/`), `/http/saml/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/tls-termination/`), `/http/tls-termination/` ],
    [ fromIncludes(`/docs/cloud-edge/modules/webhook-verification/`), `/http/webhook-verification/` ],
    [ fromIncludes(`/docs/cloud-edge/observability/`), `/http/#observability` ],
    [ fromIncludes(`/docs/cloud-edge/pops/`), `/network-edge/#points-of-presence` ],
    [ fromIncludes(`/docs/cloud-edge/zero-knowledge-tls/`), `/tls/tls-termination/#zero-knowledge-tls` ],
    [ fromIncludes(`/docs/events/`), `/obs/` ],
    [ fromIncludes(`/docs/events/reference/`), `/obs/reference/` ],
    [ fromIncludes(`/docs/secure-tunnels/`), `/agent/` ],
    [ fromIncludes(`/docs/secure-tunnels/agent_ingress/`), `/agent/ingress/` ],
    [ fromIncludes(`/docs/secure-tunnels/agentless/`), `/agent/#using-ngrok-without-the-agent` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/`), `/agent/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/api-access/`), `/agent/api/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/automatic-updates/`), `/agent/#updates` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/configuration-file/`), `/agent/config/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/diagnose-command/`), `/agent/#troubleshooting-connectivity` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/installing-as-a-service/`), `/agent/#background-service` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/reference/api/`), `/agent/api/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/reference/changelog/`), `/agent/changelog/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/reference/config/`), `/agent/config/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/reference/ngrok/`), `/agent/cli/` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/remote-management/`), `/agent/#remote-management` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/shell-autocompletion/`), `/agent/#tab-completion` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/supported-platforms/`), `/agent/#system-requirements` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/tunnel-authtokens/`), `/agent/#authtokens` ],
    [ fromIncludes(`/docs/secure-tunnels/ngrok-agent/web-inspection-interface/`), `/agent/web-inspection-interface/` ],
    [ fromIncludes(`/docs/secure-tunnels/non-local/`), `/http/#forward-to-non-local` ],
    [ fromIncludes(`/docs/secure-tunnels/tunnels/`), `/agent/` ],
    [ fromIncludes(`/docs/secure-tunnels/tunnels/http-tunnels/`), `/http/` ],
    [ fromIncludes(`/docs/secure-tunnels/tunnels/ssh-reverse-tunnel-agent/`), `/agent/ssh-reverse-tunnel-agent/` ],
    [ fromIncludes(`/docs/secure-tunnels/tunnels/tcp-tunnels/`), `/tcp/` ],
    [ fromIncludes(`/docs/secure-tunnels/tunnels/tls-tunnels/`), `/tls/` ],
]
